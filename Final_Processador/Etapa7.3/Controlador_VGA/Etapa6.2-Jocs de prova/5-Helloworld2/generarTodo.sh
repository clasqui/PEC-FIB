...
sisa-objdump -d -z --section=.sistema temp_HelloWorld2.o >HelloWorld2.code
sisa-objdump -s -z --section=.sysdata temp_HelloWorld2.o >HelloWorld2.data
...
sisa-objdump -S -x -w --section=.sistema temp_HelloWorld2.o >HelloWorld2.dis
sisa-objdump -S -x -w --section=.sysdata temp_HelloWorld2.o >>HelloWorld2.dis
