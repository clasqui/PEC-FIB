...
-- Equation(s):
-- \Mux0~0_combout\ = (\SW~combout\(0) & (((\SW~combout\(1)) # (\KEY~combout\(1))))) # (!\SW~combout\(0) & (\KEY~combout\(0) & (!\SW~combout\(1))))
...
-- Equation(s):
-- \Mux0~1_combout\ = (\Mux0~0_combout\ & (((\KEY~combout\(3)) # (!\SW~combout\(1))))) # (!\Mux0~0_combout\ & (\KEY~combout\(2) & (\SW~combout\(1))))
